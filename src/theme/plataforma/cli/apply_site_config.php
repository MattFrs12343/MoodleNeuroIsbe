...
cli_writeln('OK: additionalhtmlfooter actualizado (footer legal, constelaciones del login, splash y saludo en el hero de la Página Principal para usuarios logueados).');
